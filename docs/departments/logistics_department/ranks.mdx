...
- Fill out pass the Senior Logistics Officer course or handpicked by the High Command (in rare eventualities will handpicking occur, must be approved by the Overseer)
- Have the rank of Logistics Officer
:::

:::info
**Entrance Method to the Logistics Department Medium Command:**
...
- Filling out the Medium Command interest form (in order to grant you access to the course)

**Note: This is a work in progress as for now and is not currently up and runnning. This will serve as an alternate method to becoming a Senior Logistics Officer with a more practical-based approach rather than solely relying on results for written evaluations.**
:::
...
- Successfully obtained at least two vehicle certifications. 
...
- Accumulate a total of 10 hours on-site (you are able to check your time on team via HELIX)
